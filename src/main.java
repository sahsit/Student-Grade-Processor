...
public class Main {
    public static void main(String[] args) {
        ...
        CourseParser crParser = new CourseParser(new ErrorHandler());
        StudentParser stParser = new StudentParser(new ErrorHandler());
        GradeManager grManager = new GradeManager(crParser, stParser); 
        grManager.manage("NameFile.txt", "CourseFile.txt");
